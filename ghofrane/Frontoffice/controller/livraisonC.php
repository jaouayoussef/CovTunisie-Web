...
{
		$sql="UPDATE livraison SET id=:idd,nom=:nom, prenom=:prenom,Pays=:Pays, tel=:tel, date_livraison=:date_livraison, email=:email, adresse=:adresse WHERE id=:id";
...
$datas = array(':idd'=>$idd, ':nom'=>$nom, ':prenom'=>$prenom,':Pays'=>$Pays,':tel'=>$tel,':date_livraison'=>$date_livraison, ':email'=>$email, ':adresse'=>$adresse);
