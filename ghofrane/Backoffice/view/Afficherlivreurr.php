...
if (isset($_GET['key'])) {
	$listelivreurr = $livreurr1C->rechercherlivreurr($_GET['key']);
} else {
	$listelivreurr = $livreurr1C->Afficherlivreurr();
}
if (isset ($_POST['supprimer']))
{   
$req="delete from livreurr where cin=".$_POST['cin'];
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Gestion livraison</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
				...
				<form class="form-inline d-none d-sm-inline-block" methode="get" action="Afficherlivreurr.php">
					<div class="input-group input-group-navbar">
						<input type="text" class="form-control" name="key" placeholder="Search…" aria-label="Search">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Gestion Livreur</h1>

					<div class="row">
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Les Livreur</h5>
								</div>
...
<th>Votre secteur</th>
<th>Votre tel</th>
<th>Votre date_naiss</th>
<th>Votre mail</th>
<th>Votre adresse</th>
<th>Votre num_permis</th>
...
foreach($listelivreurr as $row)
{
	...
	<td>
                                                            <form method="POST" action="Afficherlivreurr.php" >
                                                            <input style="background-color: #495156" class="btn btn-primary btn-block" type="submit" name="supprimer" value="supprimer">
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['cin']; ?>" name="cin">
                                                            </form>
                                                            </td>
	<td><a href="modifierlivreurr.php?cin=<?PHP echo $row['cin']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
