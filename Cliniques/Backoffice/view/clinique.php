...
{
  $req="insert INTO liste_clinique(nom_clinique,description,photo) values ('".$_POST['nom_clinique']."','".$_POST['description']."','".$_POST['photo']."')";
   
  $db=config::getConnexion();  
  $sql=$db->prepare($req); 
  $sql->execute(); 
 echo "<script> ok(); </script>" ;
 echo '<body onLoad="alert(\'Clinique Ajoutée\')">';
		echo '<meta http-equiv="refresh" content="0;URL=AfficherC.php">';
}
...
<label style="font-weight: bold"> Nom du clinique </label> 
<input type="text" class="form-control" name="nom_clinique" placeholder="Nom du clinique" value="" onblur="verifReff(this)" style="width:200px"> </br>

<label style="font-weight: bold"> Description</label> 
<input type="text" class="form-control" name="description" placeholder="Description" value="" onblur="verifReff(this)" style="width:500px"> </br>
<label style="font-weight: bold">Ajouter une photo</label>
<input type="file" class="form-control" name="photo" > </br>
<input type="submit" value="valider" name="valider" action="AfficherC.php"> 
