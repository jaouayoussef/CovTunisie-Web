...
isset($_POST["login"]) ) {
        ...
        $req="insert INTO livreurr(cin,login,nom,prenom,dispo,secteur,tel,date_naiss,mail,adresse,num_permis) values ('".$cin."','".$login."','".$nom."','".$prenom."','".$dispo."','".$secteur."','".$tel."','".$date_naiss."','".$mail."','".$adresse."','".$num_permis."')";

        $obj = $mysqli->query($req);
        ...
        header('Location:livreur.php?uploaded');
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item active"><a class="sidebar-link" href="addlivreur.php">Add Livreur</a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Ajouter livreur</h1>

					<div class="row">
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Ajouter un livreur</h5>
									<h6 class="card-subtitle text-muted">Entrez les information de livreur</h6>
								</div>
								...
								<div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
											...
											<input type="text" class="form-control" placeholder="Dispo" name="dispo" required>
										</div>
                                        <div class="mb-3">
											<label class="form-label">Secteur</label>
											<input type="text" class="form-control" placeholder="Secteur" name="secteur" required>
										</div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
											...
											<input type="text" class="form-control" placeholder="Date naissance" name="date_naiss" required>
										</div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
											...
											<input type="text" class="form-control" placeholder="Numero Permis" name="num_permis" required>
										</div>
