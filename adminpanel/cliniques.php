...
$list = $mysqli->query("SELECT * FROM `liste_clinique`") or die("db error");
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item active"><a class="sidebar-link" href="cliniques.php">Cliniques List</a></li>
								...
								<div class="card-body">
									<table id="datatables-reponsive" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											echo '<tr>
												<td id="id">' . $row["id"] . '</td>
												<td id="nom_clinique">' . $row["nom_clinique"] . '</td>
												<td id="description">' . $row["description"] . '</td>
												<td id="notice"><a href="../images/cliniques/' . $row["photo"] . '">' . $row["photo"] . '</td>
                                                <td id="actions">
                                                ...
                                                ">
                                                        ...
                                                        <span>
                                                        <button id="edit" formaction="editclinique.php" class="btn btn-success" action="accept"><i class="fa fa-edit"></i></button>
  ...
  $('.deletebutton').each(function(btn){
        $(this).click(function(){
			...
			setTimeout(function()
			{
				...
				$.get( "deleteclinique.php?id="+$(this).parent().siblings("#id").text(), function( data ) {
