...
if(!isset($_SESSION["loggeduser"]) || $_SESSION["loggeduser"]["role"] != 1)
{
    ...
    $editproduit = $produitC->retrieveproducts($_POST['id']);
    ...
    isset($_POST["nbr"])) {
        ...
        !empty($_POST["notice"])&&
        !empty($_POST["nbr"])) {
            $produit=new produit($_POST['type'], $_POST['prix'], 0, $_POST['notice'],$_POST['nbr']);
            $produitC->updateproducts($produit, $_POST['id']);
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item"><a class="sidebar-link" href="addproduct.php">Add Product</a></li>
							<li class="sidebar-item active"><a class="sidebar-link" href="editproduct.php">Edit Product</a></li>
						</ul>
					</li>
						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Product Id <?PHP echo $editproduit['id'];  ?></h5>
									<h6 class="card-subtitle text-muted">Change product id <?PHP echo $editproduit['id'];  ?> information</h6>
								</div>
								<div class="card-body">
                                    <form method="POST">
                                        <input type="hidden" value=<?PHP echo $editproduit['id'];  ?> name="id">
										<div class="mb-3">
											<label class="form-label">Type</label>
											<input type="text" class="form-control" value="<?PHP echo $editproduit['type'];  ?>" name="type">
										</div>
										<div class="mb-3">
                                            <label class="form-label">Prix</label>
											<input type="number" class="form-control" value="<?PHP echo $editproduit['prix'];  ?>" name="prix" >
										</div>
										<div class="mb-3">
											<label class="form-label">Notice</label>
											<textarea class="form-control" name="notice" rows="1"><?PHP echo $editproduit['notice'];  ?></textarea>
										</div>
										<div class="mb-3">
                                            <label class="form-label">Nombre</label>
											<input type="number" name="nbr" class="form-control" value="<?PHP echo $editproduit['nbr'];  ?>">
										</div>
