...
$id =  $mysqli->real_escape_string($_POST["id"]);
    ...
    $livreur = $mysqli->query("SELECT * FROM `livraison` WHERE id='$id' LIMIT 1");
    ...
    isset($_POST["prenom"])) {
        ...
        $livid =  $mysqli->real_escape_string($_POST["livid"]);
        $date_livraison =  $mysqli->real_escape_string($_POST["date_livraison"]);
        ...
        $obj = $mysqli->query("UPDATE `livraison` SET `nom` = '$nom', `prenom` = '$prenom', `livr` = '$livid', `date_livraison` = '$date_livraison', `email` = '$email', `adresse` = '$adresse', `tel` = '$tel' WHERE `livraison`.`id` = '$id';");
        if(!$obj)
        {
...
<li class="sidebar-item active"><a class="sidebar-link" href="#">Edit Livraison</a></li>
						</ul>
					</li>
						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Livraison Id <?PHP echo $thelivreur['id'];  ?></h5>
									<h6 class="card-subtitle text-muted">Change livraison id <?PHP echo $thelivreur['id'];  ?> information</h6>
								</div>
								<div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
											<label class="form-label">Id de livreur</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['livid'];  ?>" name="Pays">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Date livraison</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['date_livraison'];  ?>" name="date_livraison">
										</div>
                                        <div class="mb-3">
