...
isset($_POST["description"]) ) {
    if(isset($_FILES['image'])){
        ...
        if(empty($errors)==true){
		   ...
		   move_uploaded_file($file_tmp, "../images/cliniques/". $finalFileName);
        ...
        $req="insert INTO liste_clinique(nom_clinique,description,photo) values ('".$nom_clinique."','".$description."','".$finalFileName."')";
        ...
        header('Location:cliniques.php?uploaded');
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item active"><a class="sidebar-link" href="addclinique.php">Add Clinique</a></li>
							...
							<div class="card">
								...
								<div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
										<div class="mb-3">
											<label class="form-label">Nom clinique</label>
											<input type="text" class="form-control" placeholder="Nom" name="nom_clinique">
										</div>
										<div class="mb-3">
