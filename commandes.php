...
$reportstable = $mysqli->query("SELECT * FROM `commandes`") or die("db error");
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th style="width:40%">num commende</th>
									...
									<tbody>
										...
										<td class="table-action">
											<a class="deleteCommande" commandeId="'. $row["id"] . '"><i class="align-middle" data-feather="trash"></i></a>
										</td>
									</tr>';
...
$('.deleteCommande').each(function(btn){
        $(this).click(function(){

			console.log("deletecommande.php?id="+this.getAttribute("commandeId"));
				$.get( "deletecommande.php?id="+this.getAttribute("commandeId"), function( data ) {
