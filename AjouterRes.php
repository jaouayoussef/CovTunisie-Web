...
$con = mysqliHelper::getCon();
$nom =  $con->real_escape_string($_POST["nom"]);
$prenom =  $con->real_escape_string($_POST["prenom"]);
$dateDeTest =  $con->real_escape_string($_POST["dateDeTest"]);
$clinique =  $con->real_escape_string($_POST["categ"]);

$datecreation = date(DATE_RFC2822) ;

$reg="insert into reservation (nom,prenom,dateDeTest,clinique,datecreation,userid) values('$nom','$prenom','$dateDeTest','$clinique','$datecreation','". $_SESSION["loggeduser"]["id"] . "')";
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="user-form">
                    <center><h2 class="widget-title font-size-30">Reservation Complete!</h2>
                    <div class="section-description pt-3">
                        <p class="section__desc font-size-16">
                            Your reservation have been successfully added to our system!
                        </p>
                    </div>
                    </center>
                </div>
