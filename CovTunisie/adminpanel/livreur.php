...
$list = $mysqli->query("SELECT * FROM `livreurr`") or die("db error");
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item active"><a class="sidebar-link" href="livreur.php">Livreurs List</a></li>
								...
								<div class="card-body">
									<table id="datatables-reponsive" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											echo '<tr>
												<td id="id">' . $row["id"] . '</td>
												<td id="cin">' . $row["cin"] . '</td>
												<td id="login">' . $row["login"] . '</td>
												<td id="nom">' . $row["nom"] . '</td>
												<td id="prenom">' . $row["prenom"] . '</td>
												<td id="dispo">' . $row["dispo"] . '</td>
												<td id="secteur">' . $row["secteur"] . '</td>
												<td id="tel">' . $row["tel"] . '</td>
												<td id="date_naiss">' . $row["date_naiss"] . '</td>
												<td id="mail">' . $row["mail"] . '</td>
												<td id="adresse">' . $row["adresse"] . '</td>
												<td id="num_permis">' . $row["num_permis"] . '</td>
                                                <td id="actions">
                                                ...
                                                ">
                                                        ...
                                                        <span>
                                                        <button id="edit" formaction="editlivreur.php" class="btn btn-success" action="accept"><i class="fa fa-edit"></i></button>
  ...
  $('.deletebutton').each(function(btn){
        $(this).click(function(){
			...
			setTimeout(function()
			{
				...
				$.get( "deletelivreur.php?id="+$(this).parent().siblings("#id").text(), function( data ) {
