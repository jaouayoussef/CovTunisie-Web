...
$list = $mysqli->query("SELECT * FROM `livraison`") or die("db error");
...
<li class="sidebar-item active"><a class="sidebar-link" href="livraison.php">Livraisons</a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste livraison</h1>
					</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Liste des livraison</h5>
								</div>
								<div class="card-body">
									<table id="datatables-reponsive" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											echo '<tr>
												...
												<td id="date_livraison">' . $row["date_livraison"] . '</td>
												<td id="email">' . $row["email"] . '</td>
												<td id="adresse">' . $row["adresse"] . '</td>
												<td id="tel">' . $row["tel"] . '</td>
                                                <td id="actions">
                                                ...
                                                ">
                                                        ...
                                                        <span>
                                                        <button id="edit" formaction="editlivraison.php" class="btn btn-success" action="accept"><i class="fa fa-edit"></i></button>
  ...
  $('.deletebutton').each(function(btn){
        $(this).click(function(){
			...
			setTimeout(function()
			{
				...
				$.get( "deletelivraison.php?id="+$(this).parent().siblings("#id").text(), function( data ) {
