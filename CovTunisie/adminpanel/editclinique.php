...
$id =  $mysqli->real_escape_string($_POST["id"]);
    ...
    $clinique = $mysqli->query("SELECT * FROM `liste_clinique` WHERE id='$id' LIMIT 1");
    $theclinic = mysqli_fetch_assoc($clinique);
    if(!$theclinic)
    {
        header('Location:cliniques.php');
        die();
    ...
    if (isset($_POST["nom_clinique"]) &&
    isset($_POST["description"])) {
        $nom_clinique =  $mysqli->real_escape_string($_POST["nom_clinique"]);
        $description =  $mysqli->real_escape_string($_POST["description"]);



        $obj = $mysqli->query("UPDATE `liste_clinique` SET `nom_clinique` = '$nom_clinique', `description` = '$description' WHERE `liste_clinique`.`id` = '$id';");
        if(!$obj)
        {
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item"><a class="sidebar-link" href="reservation.php">Reservations</a></li>
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="#">Edit Clinique</a></li>
						</ul>
					</li>
						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Clinique Id <?PHP echo $theclinic['id'];  ?></h5>
									<h6 class="card-subtitle text-muted">Change clinique id <?PHP echo $theclinic['id'];  ?> information</h6>
								</div>
								<div class="card-body">
                                    <form method="POST">
                                        <input type="hidden" value=<?PHP echo $theclinic['id'];  ?> name="id">
										<div class="mb-3">
											<label class="form-label">Nom</label>
											<input type="text" class="form-control" value="<?PHP echo $theclinic['nom_clinique'];  ?>" name="nom_clinique">
										</div>
										<div class="mb-3">
											<label class="form-label">Description</label>
											<textarea class="form-control" name="description" rows="1"><?PHP echo $theclinic['description'];  ?></textarea>
										</div>
