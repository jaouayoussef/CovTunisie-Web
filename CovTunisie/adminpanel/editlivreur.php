...
$id =  $mysqli->real_escape_string($_POST["id"]);
    ...
    $livreur = $mysqli->query("SELECT * FROM `livreurr` WHERE id='$id' LIMIT 1");
    $thelivreur = mysqli_fetch_assoc($livreur);
    if(!$thelivreur)
    {
        header('Location:livreur.php');
        die();
    ...
    isset($_POST["login"])) {
        ...
        $secteur =  $mysqli->real_escape_string($_POST["secteur"]);
        $tel =  $mysqli->real_escape_string($_POST["tel"]);
        $date_naiss =  $mysqli->real_escape_string($_POST["date_naiss"]);
        $mail =  $mysqli->real_escape_string($_POST["mail"]);
        $adresse =  $mysqli->real_escape_string($_POST["adresse"]);
        $num_permis =  $mysqli->real_escape_string($_POST["num_permis"]);



        $obj = $mysqli->query("UPDATE `livreurr` SET `login` = '$login', `nom` = '$nom', `cin` = '$cin', `prenom` = '$prenom', `dispo` = '$dispo', `secteur` = '$secteur', `tel` = '$tel', `date_naiss` = '$date_naiss', `mail` = '$mail', `adresse` = '$adresse', `num_permis` = '$num_permis' WHERE `livreurr`.`id` = '$id';");
        if(!$obj)
        {
...
<li class="sidebar-item"><a class="sidebar-link" href="commandes.php">Commandes</a></li>
					...
					<li class="sidebar-item">
						...
						<ul id="ui2" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
						...
						<li class="sidebar-item"><a class="sidebar-link" href="addlivreur.php">Add Livreur</a></li>
							<li class="sidebar-item active"><a class="sidebar-link" href="#">Edit Livreur</a></li>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Edit Product</h1>
                                <!-- cin,login,nom,prenom,dispo,secteur,tel,date_naiss,mail,adresse,num_permis -->

					<div class="row">
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Clinique Id <?PHP echo $thelivreur['id'];  ?></h5>
									<h6 class="card-subtitle text-muted">Change clinique id <?PHP echo $thelivreur['id'];  ?> information</h6>
								</div>
								<div class="card-body">
                                    <form method="POST">
                                        <input type="hidden" value=<?PHP echo $thelivreur['id'];  ?> name="id">
										<div class="mb-3">
											<label class="form-label">Cin</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['cin'];  ?>" name="cin">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Login</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['login'];  ?>" name="login">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Nom</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['nom'];  ?>" name="nom">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Prenom</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['prenom'];  ?>" name="prenom">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Dispo</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['dispo'];  ?>" name="dispo">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Secteur</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['secteur'];  ?>" name="secteur">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Tel</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['tel'];  ?>" name="tel">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Date Naissance</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['date_naiss'];  ?>" name="date_naiss">
										</div>
                                        <div class="mb-3">
											<label class="form-label">E-mail</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['mail'];  ?>" name="mail">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Addresse</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['adresse'];  ?>" name="adresse">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Numero Permis</label>
											<input type="text" class="form-control" value="<?PHP echo $thelivreur['num_permis'];  ?>" name="num_permis">
										</div>
