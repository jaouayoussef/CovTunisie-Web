<?php
    ...
    isset($_POST["notice"])) {
        ...
        !empty($_POST["gramme"]) &&
        !empty($_POST["notice"])) {) {
            $produit=new produit($_POST['type'], $_POST['prix'], $_POST['gramme'], $_POST['notice']);
            $nutritionistsC->updateproducts($produit, $_POST['id']);
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="gramme" name="gramme" required="">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="prix" name="prix" required="">
                        </div>
                        <div class="input-group">
