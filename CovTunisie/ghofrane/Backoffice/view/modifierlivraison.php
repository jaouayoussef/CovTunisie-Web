...
<td><input type="text" name="date_livraison" value="<?PHP echo $date_livraison ?>"></td>
</tr>
<tr>
<td>mail</td>
...
if (isset($_POST['modifier'])){
  $livraison=new livraison($_POST['nom'],$_POST['prenom'],$_POST['nom'],$_POST['Pays'],$_POST['tel'],$_POST['date_livraison'],$_POST['email'],$_POST['adresse']);
  $livraisonC->modifierlivraison($livraison,$_POST['idd']);
}
?>
							</div>
						</div>
