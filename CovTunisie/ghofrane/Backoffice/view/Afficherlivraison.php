...
{   
$req="delete from livraison where id=".$_POST['id'];
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Gestion Livraison</h1>

					<div class="row">
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Les Livraison</h5>
								</div>
...
foreach($listelivraison as $row)
{
	...
	<td><form method="POST" action="Afficherlivraison.php">
