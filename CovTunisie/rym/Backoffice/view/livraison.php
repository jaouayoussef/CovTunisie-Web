					...
					<div class="row">
						<div class="col-12 col-xl-6">
							<div class="card">
								...
								<form name="f1" method="GET" action="Ajouterlivreurr.php">
              <table  class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <caption>Ajouter livreurr</caption>
                <thead>
                  <tr>
                    <th>Cin</th>
                    <th>login</th>
                ...
                <tfoot>
                <tr>
<td>Cin<input type="number" name="cin" id="cin" min="1" max="99999999" minlength="8" maxlength="8" required value=""></td>
					<br>
<td>Login<input type="text" name="login"></td>
<td>Nom<input type="text" name="nom"></td>
<td>Prénom <input type="text" name="prenom"></td>
  <td>dispo<input type ="text" name="dispo"></td>
   <td> secteur<input type="text" name="secteur"></td>
<td></td>
<td>tel<input type="number" name="tel"></td>
<td>date_naiss<input type="date" name="date_naiss"></td>
<td>mail<input type="text" name="mail"></td>
<td>adresse<input type="text" name="adresse"></td>
<td>num permis<input type="number" name="num_permis"></td>
</tr>
                  </tr>
                </tbody>
              </table>
