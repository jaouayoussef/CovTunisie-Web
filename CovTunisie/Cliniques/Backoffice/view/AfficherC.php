...
if (isset($_GET['key'])) {
		   $listP = $prod->recherchecliniquee($_GET['key']);
	   } else {
...
{   
$req="delete from liste_clinique where id=".$_POST['id'];
		...
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Gestion Test</span>
						...
						<li class="sidebar-item">
						<a class="sidebar-link" href="clinique.php">
...
echo('<td>'.$prod['nom_clinique'].'</td>');

echo('<td>'.$prod['description'].'</td>');
	
echo('<td> <img src="img/clinique/'.$prod['photo'].'" width="100" height="100" /> </td>'); 
...
<td>
<a class="btn btn-primary btn-block" href="modifierC.php?id=<?php echo $prod['id'] ?>">
Modifier
</a>
<?php
echo("</tr>");
...
?>
								 ...
								 <h5  style="color: white; background-color: green; width: 200px;" align="center"> <?php echo('Total de clinique:'.$total)?></h5>
<form method="get" action="clinique.php" >
   <button align="center" style="background-color: #0c6071; width: 300px" class="btn btn-primary btn-block" type="submit" > <a>  Ajouter un autre Clinique  </a> </button>
</form>
</br>
							</div>
						</div>
